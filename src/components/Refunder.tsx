      ...
      <Box>
        <VStack>
          ...
          <Input
            ...
            w="1000px"
          />
          <Button onClick={RequestGetTransferStatus}>Search</Button>
          <Button
          ...
          <Button onClick={sendTx} isDisabled={transferStatus.data.status != 8}>
            SendTx
          </Button>
          <Text maxWidth={1000}>
            <pre>{JSON.stringify(showResult, null, 4)}</pre>
          </Text>
        </VStack>
      </Box>
    </VStack>
